...
abstract class BasesfGuardUserForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'last_visit'       => new sfWidgetFormDateTime(),
    ...
    $this->setValidators(array(
      ...
      'licence'          => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'last_visit'       => new sfValidatorDateTime(array('required' => false)),
